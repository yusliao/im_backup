...
namespace IMClient.Helper
{
    ...
    {
        public static System.Windows.Media.ImageSource GetFileImage(string filePath, bool isScan)
        {
            if (string.IsNullOrEmpty(filePath))
            {
                return IMAssets.ImageDeal.File_default0;
            }
            ...
            { 
                case ".doc":
                case ".docx":
                    return IMAssets.ImageDeal.File_word0;
                case ".xls":
                case ".xlsx":
                    return IMAssets.ImageDeal.File_excel0; 
                case ".ppt":
                    return IMAssets.ImageDeal.File_ppt0;
                case ".exe":
                case ".msi":
                    return IMAssets.ImageDeal.File_exe0;
                case ".txt": 
                    return IMAssets.ImageDeal.File_text0;
                case ".mp3":
                    return IMAssets.ImageDeal.File_mp30;
                case ".mp4":
                case ".mpg":
                case ".mpeg":
                case ".avi":
                ...
                case ".wmv":
                case ".asf":
                    return IMAssets.ImageDeal.File_mp40; 
                case ".pdf": 
                    return IMAssets.ImageDeal.File_pdf0;
                case ".gif":
                case ".jpeg":
                case ".jpg":
                case ".png":
                case ".bmp":
                    return IMAssets.ImageDeal.File_image0;  
                case ".zip":
                case ".rar":
                case ".gzip":
                case ".7z":
                case ".z":
                case ".iso":
                    return IMAssets.ImageDeal.File_rar0;
    ...
    public class WindowsThumbnailProvider
    {
        ...
        public static BitmapSource GetFileThumbnail(string fileName, int width = 60, int height = 60, ThumbnailOptions options = ThumbnailOptions.IconOnly)
        {
            ...
            try
            {
                var tempSource = new System.Drawing.Bitmap(fileName);

                var With = (int)Math.Min(tempSource.Width, 300);
                var h = With * tempSource.Height / tempSource.Width;
                if (h == 0)
                {
                    h = tempSource.Height;
                }
                //var bmp = Util.ImageProcess.GetThumbnail(fileName, With, h);

                Bitmap bitmap = GetThumbnail(fileName, With, h, options);
                //var bitmap = Util.ImageProcess.GetThumbnail(fileName, width, width);
            ...
            catch
            {
                try
                {
                    ...
                    return GetBitmapImage(fileName);
                }
                catch
                {
                    return IMAssets.ImageDeal.DefaultImage;
