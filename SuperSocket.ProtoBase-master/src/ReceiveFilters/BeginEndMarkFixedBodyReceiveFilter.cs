...
namespace SuperSocket.ProtoBase
{
    ...
    public abstract class BeginEndMarkFixedBodyReceiveFilter<TPackageInfo> : IReceiveFilter<TPackageInfo>, IPackageResolver<TPackageInfo>
        where TPackageInfo : IPackageInfo
    {
        ...
        private int m_packageLen = 0;
        private byte[] m_packagelenbuffer;
        private int m_IsReadLen = 0;
        private int m_FixedLen = 0;
        /// <summary>
